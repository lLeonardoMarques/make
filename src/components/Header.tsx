...
export const Header: React.FC<HeaderProps> = ({ activeTab, onSelectTab }) => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full transition-colors duration-200">
      ...
      <div className={
        theme === 'escuro' 
          ? 'bg-black text-white text-xs py-1.5 px-4 border-b border-zinc-900' 
          : 'bg-zinc-950 text-white text-xs py-1.5 px-4 border-b border-zinc-800'
      }>
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2 text-center sm:text-left">
          <div className="flex items-center justify-center gap-2 mx-auto sm:mx-0 font-medium">
            <span className="bg-pink-500 text-white px-2 py-0.5 rounded-full text-[9px] uppercase font-black tracking-widest">
              OFERTA
            </span>
            <span className="text-[11px] text-zinc-200">
              Cupom <strong className="text-pink-400 font-bold">GATAMAKE10</strong> para 10% OFF na primeira compra!
            </span>
          </div>

          <div className="hidden md:flex items-center gap-4 text-[10px] text-zinc-300 font-semibold uppercase tracking-wider">
            <span className="flex items-center gap-1.5">
              <MapPin className="w-3.5 h-3.5 text-pink-500" />
              R. das Pedras, 326 - Zona Norte SP
            </span>
      ...
      <div className={`backdrop-blur-md border-b transition-colors duration-200 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2 sm:gap-4">
          ...
          {/* Brand Logo - Strictly Single Line, Aesthetic & Professional */}
          <button 
            onClick={() => onSelectTab('inicio')}
            className="flex items-center gap-2.5 sm:gap-3 group focus:outline-none text-left shrink-0"
            title="Ir para o início"
          >
            <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl flex items-center justify-center font-serif font-black text-base shadow-sm transition-all duration-300 group-hover:scale-105 ${
              theme === 'escuro'
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center whitespace-nowrap">
                <span className={`font-serif font-black text-base sm:text-xl tracking-tight leading-none ${
          ...
          {/* Desktop Navigation with Aesthetic Hover Dropdown Submenus */}
          <nav className="hidden lg:flex items-center gap-1 xl:gap-1.5 text-xs font-bold uppercase tracking-wider">
            
            {/* 1. INÍCIO */}
            <div className="relative group">
              <button
                onClick={() => onSelectTab('inicio')}
                className={`px-3 py-2 rounded-full flex items-center gap-1.5 transition-all text-xs font-bold ${
                  activeTab === 'inicio'
                    ? theme === 'escuro'
            ...
            {/* 2. VITRINE (COM MEGA DROPDOWN DE CATEGORIAS) */}
            <div className="relative group">
              <button
              ...
              {/* Submenu Dropdown: Vitrine & Categorias */}
              <div className="absolute top-full left-0 pt-2 w-80 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-out transform translate-y-1 group-hover:translate-y-0 z-50">
                <div className={`rounded-2xl border p-3 shadow-2xl backdrop-blur-xl ${
                  ...
                  <div className="grid grid-cols-1 gap-1">
                    ...
                    >
                      ...
                      <div>
                        <span className="font-bold text-xs block normal-case">Bases & Preparação de Pele</span>
                        <span className="text-[10px] text-zinc-500 dark:text-zinc-400 font-medium block normal-case">Bases, corretivos, pó e blush</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-zinc-500 dark:text-zinc-400 font-medium block normal-case">Paletas, máscaras e delineadores</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-zinc-500 dark:text-zinc-400 font-medium block normal-case">Kits completos e esponjas soft</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="text-[10px] text-zinc-500 dark:text-zinc-400 font-medium block normal-case">Séruns, hidratantes e fixadores</span>
                      </div>
                    </button>
                    ...
                    >
                      ...
                      <div>
                        <span className="font-bold text-xs block normal-case">Combos & Kits Especiais</span>
            ...
            {/* 3. PROMOÇÕES (COM SUBMENU DE OFERTAS & CUPONS) */}
            <div className="relative group">
              <button
              ...
              {/* Submenu Dropdown: Promoções */}
              <div className="absolute top-full left-0 pt-2 w-72 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-out transform translate-y-1 group-hover:translate-y-0 z-50">
                <div className={`rounded-2xl border p-3 shadow-2xl backdrop-blur-xl ${
                  theme === 'escuro'
                    ? 'bg-zinc-950/98 border-zinc-800 text-white'
                    : 'bg-white/98 border-zinc-200 text-zinc-950'
            ...
            <div className="relative group">
              ...
              >
                ...
                <span>Espaço & Fotos</span>
                <ChevronDown className="w-3 h-3 opacity-60 group-hover:rotate-180 transition-transform duration-200" />
              </button>

              {/* Submenu Dropdown: Fotos & Loja */}
              <div className="absolute top-full left-0 pt-2 w-64 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-out transform translate-y-1 group-hover:translate-y-0 z-50">
                <div className={`rounded-2xl border p-3 shadow-2xl backdrop-blur-xl ${
                  theme === 'escuro'
                    ? 'bg-zinc-950/98 border-zinc-800 text-white'
                    : 'bg-white/98 border-zinc-200 text-zinc-950'
                  ...
                  <div className="space-y-1">
                    ...
                    >
                      ...
                      <div>
                        <span className="font-bold text-xs block normal-case">Fotos da Loja Física</span>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="hidden sm:flex items-center gap-1.5 px-3 py-2 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] font-bold uppercase tracking-wider shadow-sm transition-all active:scale-95"
            ...
            <button
              ...
              className={`relative px-3.5 py-2 rounded-full text-[11px] font-bold uppercase tracking-wider shadow-sm transition-all active:scale-95 flex items-center gap-1.5 ${
                theme === 'escuro'
            ...
            >
              ...
              <span className="bg-pink-500 text-white text-[9px] font-black px-1.5 py-0.2 rounded-full min-w-[1.1rem] text-center">
                {totalItemsCount}
              </span>
            </button>
      ...
      {/* Modular Mobile Menu with Nested Submenu Support */}
      <MobileMenu
